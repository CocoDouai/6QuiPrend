      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="jumbotron">
            ...
            <div class="avatar">
              <img src="css/image/photo_profil.png" alt="choisissez une image">
            </div>
            </div>
            <div class="colcol-xs-6 col-lg-6">
            <div class="attributs">
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
            ...
            <a href="#" class="list-group-item">Luke<img src="css/image/fond.jpg" alt=""></a>
            <a href="#" class="list-group-item">Dooku<img src="css/image/fond.jpg" alt=""></a>
            <a href="#" class="list-group-item">Aayla Secura<img src="css/image/fond.jpg" alt=""></a>
